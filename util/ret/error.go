...
var (
	...
	ErrPermission = &retErr{Code: 10001, Message: "Need to check permissions"}
	// system errors

	ErrValidation     = &retErr{Code: 20001, Message: "Validation failed"}
	ErrParameterMatch = &retErr{Code: 20003, Message: "Insufficient or non-compliant parameters provided"}
